...
export class Database {
  ...
  private async updateEntitiesSearch(
    ...
    const entries: DbEntitiesSearchRow[] = [
      { entity_id: entityId, key: 'apiVersion', value: data.apiVersion },
      { entity_id: entityId, key: 'kind', value: data.kind },
      { entity_id: entityId, key: 'uid', value: entityId },
      { entity_id: entityId, key: 'metadata.uid', value: entityId },
    ];
    ...
    for (const [key, value] of Object.entries(labels)) {
      entries.push({ entity_id: entityId, key, value });
      entries.push({ entity_id: entityId, key: `labels.${key}`, value });
      entries.push({
        entity_id: entityId,
    ...
    for (const [key, value] of Object.entries(annotations)) {
      entries.push({ entity_id: entityId, key, value });
      entries.push({ entity_id: entityId, key: `annotations.${key}`, value });
      entries.push({
        entity_id: entityId,
        key: `metadata.annotations.${key}`,
        value,
      });
    }
